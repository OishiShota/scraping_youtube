class YoutubeApi
  ...
  API_KEY = "AIzaSyB78qHg1DD-b_rxd6okDnnOxXhBN-OAgZs"

  def self.search(search_keyword, page_token = nil)
    client = Faraday.new BASE_URL do |b| #Faradayについて → https://codezine.jp/article/detail/11462
